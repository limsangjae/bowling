			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center">
					...
					<form action="#" class="narrow-w form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
						<input type="text" class="form-control px-4" placeholder="볼링장 이름, 지역">
	...
	<div class="section">
		<div class="container">
			<div class="row mb-5 align-items-center">
				<div class="col-lg-6">
					<h2 class="font-weight-bold text-primary heading">인기 볼링장</h2>
				</div>
				<div class="col-lg-6 text-lg-end">
					<p><a href="/alley/list" target="_blank" class="btn btn-primary text-white py-3 px-4">모든 볼링장 목록</a></p>
				</div>
			</div>
			<div class="row">
