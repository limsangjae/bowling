...
<body>
    ...
    <div class="row">
      <!-- SIGN UP -->
      <form class="col align-items-center flex-col sign-up" id="join_form" method="post" accept-charset="UTF-8">
        <div class="form-wrapper align-items-center">
          <div class="form sign-up">
            ...
            <div class="input-group">
              <input class="name_input" name="memberName" type="text" placeholder="이름">
              <span class="final_name_ck">이름을 입력해주세요.</span>
            </div>
            <div class="input-group">
              <input class="age_input" name="memberAge" type="text" placeholder="나이">
              <span class="final_age_ck">나이를 입력해주세요.</span>
            </div>
            <div class="input-group">
              <input class="tel_input" name="memberTel" type="text" placeholder="전화번호">
              <span class="final_tel_ck">전화번호를 입력해주세요.</span>
            </div>
            <div class="box input-group">
			    <input class="address_input_1" name="memberAddr1" type="text" placeholder="우편번호" readonly="readonly">
			    <button class="add_btn" type="button" onclick="execution_daum_address()">주소찾기</button>
			</div>
			<div class="input-group">
              <input class="address_input_2" name="memberAddr2" type="text" placeholder="주소" readonly="readonly">
            </div>
            <div class="input-group">
              <input class="address_input_3" name="memberAddr3" type="text" placeholder="상세주소" readonly="readonly">
            </div>
